...
# Input fields
name = st.selectbox("Select Car Name", ['Hyundai Santro Xing', 'Mahindra Jeep CL550', 'Hyundai Grand i10',
...
company = st.selectbox("Select Car Company", ['Hyundai', 'Mahindra', 'Ford', 'Maruti', 'Skoda', 'Audi', 'Toyota',
       ...
       'Mercedes', 'Land', 'Jaguar', 'Jeep', 'Volvo'])  # Add your company names
year = st.number_input("Year of Manufacture", min_value=2007, max_value=2021, value=2007)
kms_driven = st.number_input("KMs Driven", min_value=0, value=400000)
fuel_type = st.selectbox("Select Fuel Type", ["Petrol", "Diesel", "LPG"])  # Add your fuel types
